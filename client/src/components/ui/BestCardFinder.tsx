...
import { Label } from "@/components/ui/label"; // adjust if your project uses a different path/casing
...
export function BestCardFinder({
    ...
    // helper to build Authorization header (no-op if not signed in)
